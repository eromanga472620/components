...
Vue.component('my-select', {
    ...
    created: function () {
        this.initData();
        this.iconclass = 'iconfont icon-' + this.icon;
        this.iconcolor = 'color:' + this.color;
    },
    watch: {
        searchTxt: function () {
            if (this.showSelect) {
    ...
    template: `
       <div class="my_select">
         ...
         <input class="selectInput" v-bind:class="{ showIcon:showicon }" v-model="valueShow" readonly :placeholder="placeholder" @click="open()">
         <span v-if="showicon" :style="iconcolor" :class="iconclass"></span>
...
//  <my-date v-model="date" :type="'date'" :showicon="true" @change="selectBM"></my-date>
//  v-model:绑定的数据
...
Vue.component('my-date', {
    ...
    template: `
       <div class="my_date">
         ...
         <span v-if="showicon" :style="iconcolor" :class="iconclass"></span>
         <van-popup v-model="showBox" position="bottom" :close-on-click-overlay="false" @click-overlay="cancel">
...
Vue.component('my-address', {
    ...
    methods: {
        ...
        onConfirmTime: function (val) {
            var address = val.map(c => c.name).join(" / ");
    ...
    template: `
       <div class="my_date">
         <input class="selectInput" v-bind:class="{ showIcon:showicon }" v-bind:value="value" readonly placeholder="请选择地址" @click="open()">
         <span v-if="showicon" :style="iconcolor" :class="iconclass"></span>
         <van-popup v-model="showBox" position="bottom" :close-on-click-overlay="false" @click-overlay="cancel">
            <van-area title="选择地址" :area-list="areaList" @confirm="onConfirmTime" @cancel="cancel" :columns-num="type"/>
         </van-popup>
       </div>
     `
})
